...
```{r}
#| label: fig-cor
#| fig-cap: This correlation matrix visualizes the relationships between key numerical predictor variables and the outcome variable, Amount. The figure shows correlations include a weak negative correlations between PreparatoryPhase and ContractDays; and weak positive correlations between predictors and Amount.
#| echo: false
#| eval: true
#| warning: false
#| message: false
...
# Heatmap plot
ggplot(contract_counts, aes(x = Period, y = Count, fill = Count)) +
  geom_tile() +
